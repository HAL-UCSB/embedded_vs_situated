Shader "Custom/SegmentFaceMeshHor"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float fillProgression = step(normalizedX, _FillAmount); // 0 if unfilled, 1 if filled (adjust UVs if needed)
                ...
                col.rgb = fillProgression; // Use the RGB from the material's color
