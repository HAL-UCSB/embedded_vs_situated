...
{
    public class UpdateActivations : MonoBehaviour
    {

        public List<ActivationBar> muscleActivations;
        public List<TextMeshProUGUI> muscleLabels;
        ...
        void Update()
        {
            ...
            if (currentExercisePhase != ExercisePhase.Exercise)
            {
                foreach (var bar in muscleActivations)
                {
                    bar.transform.parent.transform.parent.gameObject.SetActive(false);
